...
export const saveVideoBase64Example = async (): Promise<void> => {
  try {
    ...
    if (result != null) {
      ...
      //
      // For this example, the video is encoded in a Base64 string.
      // highlight-convert
      const base64 = await FileSystem.readAsStringAsync(result.video, {
        encoding: "base64",
      });
      // highlight-convert
